...
public class TelaInputTemperatura {

	//CONSTRUTOR
		public TelaInputTemperatura() {
			...
			String inputValor = (String)JOptionPane.showInputDialog(frame, "INSIRA UMA TEMPERATURA","INPUT", JOptionPane.QUESTION_MESSAGE, icon ,
				                    null,null);
		}
